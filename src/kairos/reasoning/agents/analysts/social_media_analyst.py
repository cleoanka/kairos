...
from kairos.reasoning.agents.analysts.sentiment_analyst import (  # noqa: F401
    create_sentiment_analyst,
    create_social_media_analyst,
)

_warnings.warn(
    "kairos.reasoning.agents.analysts.social_media_analyst is deprecated. "
    "Import from kairos.reasoning.agents.analysts.sentiment_analyst instead.",
    DeprecationWarning,
    stacklevel=2,
)
