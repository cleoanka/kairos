...
class ConditionalLogic:
    ...
    def should_continue_microstructure(self, state: AgentState):
        """Determine if the Microstructure (System-1) analyst tool round continues."""
        messages = state["messages"]
        last_message = messages[-1]
        if last_message.tool_calls:
            return "tools_microstructure"
        return "Msg Clear Microstructure"
