...
from kairos.reasoning.llm_clients.api_key_env import get_api_key_env
from kairos.reasoning.llm_clients.model_catalog import get_model_options
from kairos.reasoning_cli.models import AnalystType, AssetType
...
def ensure_api_key(provider: str) -> str | None:
    ...
    from kairos.reasoning.llm_clients.openai_client import OPENAI_COMPATIBLE_PROVIDERS
