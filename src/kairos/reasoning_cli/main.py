...
from kairos.reasoning.graph.analyst_execution import (
...
from kairos.reasoning_cli.announcements import display_announcements, fetch_announcements
from kairos.reasoning_cli.stats_handler import StatsCallbackHandler
from kairos.reasoning_cli.utils import (
...
def analyze(
    ...
    if clear_checkpoints:
        from kairos.reasoning.graph.checkpointer import clear_all_checkpoints
