...
from kairos.reasoning.agents.managers.portfolio_manager import create_portfolio_manager
from kairos.reasoning.agents.schemas import PortfolioDecision, PortfolioRating
...
from kairos.reasoning.graph.reflection import Reflector
...
class TestLegacyRemoval:
    ...
    def test_financial_situation_memory_removed(self):
        ...
        import kairos.reasoning.agents.utils.memory as m
