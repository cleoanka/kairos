...
from kairos.reasoning.llm_clients.api_key_env import PROVIDER_API_KEY_ENV, get_api_key_env
...
def cli_utils(monkeypatch):
    """Import kairos.reasoning_cli.utils with a fresh environment so module-level state is consistent."""
    import importlib

    import kairos.reasoning_cli.utils as cli_utils_module
