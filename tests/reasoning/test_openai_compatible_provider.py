...
from kairos.reasoning.llm_clients.factory import create_llm_client
from kairos.reasoning.llm_clients.validators import validate_model
...
def test_env_backend_url_precedence():
    ...
    from kairos.reasoning_cli.utils import resolve_backend_url
