...
from kairos.reasoning.agents.analysts.sentiment_analyst import create_sentiment_analyst
from kairos.reasoning.agents.managers.research_manager import create_research_manager
from kairos.reasoning.agents.schemas import (
    PortfolioDecision,
    PortfolioRating,
    ResearchPlan,
    SentimentBand,
...
from kairos.reasoning.agents.trader.trader import create_trader
...
def test_invoke_structured_falls_back_when_result_is_none():
    ...
    from kairos.reasoning.agents.utils.structured import invoke_structured_or_freetext
